<!-- Historical snapshot of PERFORMANCE.md at f80e8d8716cd9a59c4c5ff6434816ed562043259. -->
This is the historical performance record through September 21, 2026.
Its dated results, pending-work statements and route decisions belong to
their recorded sources. See [the current performance state](PERFORMANCE.md)
for active measurements, immutable targets and remaining qualification.
