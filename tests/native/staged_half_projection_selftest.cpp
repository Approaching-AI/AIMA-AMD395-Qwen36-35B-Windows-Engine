...
void run(unsigned rows,unsigned width){
 ...
 variant<1u>(rows,width,a,b,pa,pb,out,trace,left,right,expected,transformed);variant<2u>(rows,width,a,b,pa,pb,out,trace,left,right,expected,transformed);variant<4u>(rows,width,a,b,pa,pb,out,trace,left,right,expected,transformed);variant<8u>(rows,width,a,b,pa,pb,out,trace,left,right,expected,transformed);
}
