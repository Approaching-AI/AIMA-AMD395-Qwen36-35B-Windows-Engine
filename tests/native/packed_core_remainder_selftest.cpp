...
int main(){
 ...
 for(unsigned v=0u;v<4u;++v) {
  ...
  std::printf("{\"kind\":\"packed_core_remainder_host\",\"variant\":%u,\"groups\":500000,\"unmodified_raw_carry_states\":%u,\"path_unsupported_fast_packed_wide\":[%u,%u,%u,%u],\"packed_halfword_pairs\":1048576,\"raw_mismatches\":0,\"immutable_inputs\":true}\n",v,ordered,paths[v][0],paths[v][1],paths[v][2],paths[v][3]);
 }
}
