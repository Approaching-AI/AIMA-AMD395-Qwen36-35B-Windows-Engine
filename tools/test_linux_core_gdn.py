...
inline unsigned fake_ordered_launch_error_after=0;
...
inline int hipModuleLaunchKernel(void* function,unsigned x,unsigned y,unsigned z,
 ...
 if(fake_ordered_launch_error&&fake_module_launches.size()>=fake_ordered_launch_error_after&&
    (fake_ordered_launch_error_index<0||i-1==static_cast<unsigned>(fake_ordered_launch_error_index)))
