...
out=F/'build/persistent-gdn-preparation-controls-r2';out.mkdir()
...
helpers=('prepare_persistent_gdn_runtime_assets_r1.py','rebuild_persistent_gdn_runtime_r1.py',
    'compare_persistent_gdn_rebuild_r1.py','compare_gdn_explicit_rebuild_r2.py','record_persistent_gdn_runtime_preparation_r1.py','record_persistent_gdn_runtime_preparation_r2.py')
