...
B=Path(__file__).resolve().parent;D=B/'native-gdn-compact-windows-r1'
...
assert sha(D/'manifest.json')=='e2a6d2ded1f2a6213944b6912ff326d4cfd4e8dd68e588162cb70bcdcd2cd186'
