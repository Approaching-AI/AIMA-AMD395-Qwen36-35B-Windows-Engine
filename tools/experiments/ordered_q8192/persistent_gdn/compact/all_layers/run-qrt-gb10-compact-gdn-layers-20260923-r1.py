...
name="qrt-gb10-compact-gdn-layers-20260923-r1";root=Path("/home/qujing")/name;archive=root.with_suffix(".tar")
assert not root.exists()
assert shutil.disk_usage(root.parent).free > 4*(1<<30)
assert hashlib.sha256(archive.read_bytes()).hexdigest()=="cc1f0b3c7a2a21aa7dff9b6210f4ad7b11764d51dd6b94409495e916ee7ea7dd"
