...
arithmetic = R/'tools/experiments/ordered_q8192/persistent_gdn'
...
assert subprocess.check_output(['git','-C',str(R),'show',commit+':tools/experiments/ordered_q8192/persistent_gdn/persistent.py'],timeout=15) == target.read_bytes()
manifest.update(candidate_base_commit=commit, files=files,
    ...
    persistent_component_evidence_sha256=sha(R/'benchmarks/correctness/persistent-gdn-explicit-controls-20260923.json'),
...
dispatcher = B/'dispatch_gb10_persistent_gdn_layers_r1.py'
