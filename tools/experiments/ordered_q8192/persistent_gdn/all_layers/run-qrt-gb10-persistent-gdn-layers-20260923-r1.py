...
name="qrt-gb10-persistent-gdn-layers-20260923-r1";root=Path("/home/qujing")/name;archive=root.with_suffix(".tar")
assert not root.exists()
assert shutil.disk_usage(root.parent).free > 4*(1<<30)
assert hashlib.sha256(archive.read_bytes()).hexdigest()=="030f2027ff92092ae82ffc59d8b309d455b4dd21465a909ac6ef2188234fed4e"
