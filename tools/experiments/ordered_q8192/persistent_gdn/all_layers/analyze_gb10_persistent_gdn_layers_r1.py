...
for file in ('ordered_pipeline.py', 'group16.py', 'exp2.py', 'persistent.py'):
    original = subprocess.check_output(['git', '-C', str(P), 'show', base + ':tools/experiments/ordered_q8192/persistent_gdn/' + file], timeout=15)
...
result = dict(kind='original_q8192_all_linear_layers_persistent_explicit_gdn_comparison',
