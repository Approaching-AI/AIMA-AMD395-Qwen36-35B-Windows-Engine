...
name="qrt-gb10-explicit-q8192-layers-20260923-r1";root=Path("/home/qujing")/name;archive=root.with_suffix(".tar")
assert not root.exists()
assert shutil.disk_usage(root.parent).free > 4*(1<<30)
assert hashlib.sha256(archive.read_bytes()).hexdigest()=="060d163615d99e818d208e105194fd610c1602f2234a5223418549ab7fb35f0e"
