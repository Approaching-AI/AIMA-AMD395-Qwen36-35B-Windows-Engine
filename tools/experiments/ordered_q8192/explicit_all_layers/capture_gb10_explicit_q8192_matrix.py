...
def main():
    ...
    cases = [c for c in cases if c["name"] in ("q7169-out32", "q8192-out32", "q8192-out512")]
    ...
    timeout_limit = 1800  # Bound includes 160 dense, 10 attention and 80 routed explicit-layout original-operand comparisons.
