...
def main(argv: list[str] | None = None) -> int:
    ...
    # ASCII JSON preserves Unicode names through escapes and remains writable
    # on Windows consoles/pipes using a legacy code page. Recovered text is UTF-8.
    print(json.dumps({"schema": "aima.agent-document-inspection.v1", "qualified": qualified,
                      "documents": reports}, ensure_ascii=True, indent=2))
