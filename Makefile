...
QRT_C_HDRS := native/src/qrt.h native/src/qrt_context_limits.h native/src/qwen36_baseline.h native/src/qrt_prefix_logit.h native/src/qrt_prefix_checkpoint.h
